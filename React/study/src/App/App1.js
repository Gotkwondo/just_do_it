...
const App = () => {
  return <div>
    <MyComponent name="React(JSX내부에서 props 렌더링)" />
    <MyComponent />{/*props 기본값은 컴포넌트 파일에 컴포넌트이름.defaultProps{}의 객체 형식으로 값을 작성해 주면 된다*/}
    <MyComponent>React(태그사이의 내용을 보여주는 children)</MyComponent>
