...
var btIncrease = document.querySelector('#increase');
var btDecrease = document.querySelector('#decrease'); //프로젝트의 상태에 변화를 일으키는 것을 액션이라고 한다. 액션의 이름은 고유해야 하며 대문자로 이루어짐

var TOGGLE_SWITCH = 'TOGGLE_SWITCH';
var INCREASE = 'INCREASE';
var DECREASE = 'DECREASE'; //다음으로 액션 객체를 만드는 액션 생성 함수를 작성한다.
...
var store = (0, _redux.createStore)(reducer); //render 함수작성. 상태가 업데이트될 때마다 호출되며, 리액트의 render함수와는 다르게 
...
},{"redux":"node_modules/redux/es/redux.js"}],"C:/Users/dhwng/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/dhwng/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
